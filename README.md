...
### Notebooks
Notebooks for training and visualizations are found in the /notebooks folder. Open the visualization notebook in Google Colab to get an interactive 3D plot showing testing predictions for one forest plot. The training notebook also shows how to prepare the .las files to be used by the preprocessing script. This model can be trained on the free GPU version of Google Colab.
